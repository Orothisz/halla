...
export default function Signup() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      nav("/login", { state: { from: "/assistance" } });
    } catch (e2) {
      ...
      >
        ...
        <form onSubmit={onSubmit} className="mt-5 space-y-4">
          ...
          <label className="block">
            ...
            <div className="mt-1">
              ...
              <div className="text-[11px] text-white/60 mt-1 flex items-center gap-1">
                <Shield size={12} /> {["Very weak", "Weak", "Okay", "Good", "Strong"][score]}
              </div>
            </div>
          </label>
          ...
          <motion.button
            ...
            className="w-full mt-1 inline-flex items-center justify-center gap-2 rounded-xl border border-white/15 bg-white/10 hover:bg-white/15 px-4 py-2.5"
          >
